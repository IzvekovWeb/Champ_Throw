...
module.exports = {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      hash: false,
      template: `${PATHS.src}/www/screen-18.html`,
    ...
    new HtmlWebpackPlugin({
      hash: false,
      template: `${PATHS.src}/www/welcome-2.html`,
      filename: './welcome-2.html',
      inject: true
    }),
    new HtmlWebpackPlugin({
      hash: false,
      template: `${PATHS.src}/www/welcome-3.html`,
      filename: './welcome-3.html',
      inject: true
    }),
